...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 850.0, 80.0, 77.0, 22.0 ],
					"text" : "r eamir.clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 478.0, 532.0, 72.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 335.0, 146.0, 19.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 335.0, 146.0, 20.0, 20.0 ],
					"style" : "MMJforM"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 42.0, 51.0, 20.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 42.0, 82.0, 19.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 140.0, 151.0, 29.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 38.0, 76.0, 29.0, 22.0 ],
					"style" : "MMJforM",
					"triangle" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 41.0, 151.0, 29.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 38.0, 47.0, 29.0, 22.0 ],
					"style" : "MMJforM",
					"triangle" : 0,
					"varname" : "eamr_MIDI"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 76.0, 21.0, 175.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 257.0, 21.0, 146.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 629.0, 72.0, 32.5, 17.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 629.0, 233.0, 27.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 147.0, 24.0, 22.0 ],
					"style" : "MMJforM",
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 462.0, 201.0, 147.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 257.0, 21.0, 147.0, 22.0 ],
					"style" : "MMJforM",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 282.0, 201.0, 177.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 75.0, 21.0, 177.0, 22.0 ],
					"style" : "MMJforM",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 437.0, 504.0, 100.0, 22.0 ],
					"text" : "midiformat"
				}
